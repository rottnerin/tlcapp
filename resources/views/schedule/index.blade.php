                        ...
                        <input type="checkbox"
                            ...
                            <div class="relative p-4 rounded-lg border-2 transition-all duration-200 group-hover:shadow-md
                                ...
                                <div class="flex items-center justify-center space-x-3">
                                    <div class="w-5 h-5 rounded-full transition-all duration-200 border-2 flex items-center justify-center
                                        {{ in_array($division->id, $selectedDivisions) ? 'border-amber-500 bg-amber-500' : 'border-gray-400 bg-white group-hover:border-amber-400' }}">
