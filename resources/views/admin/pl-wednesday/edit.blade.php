                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <div class="time-picker-group">
                            @php
                                $startTime = old('start_time', $plWednesday->start_time ? \Carbon\Carbon::parse($plWednesday->start_time)->format('H:i') : '15:00');
                    ...
                    <div>
                        ...
                        <div class="time-picker-group">
                            @php
                                $endTime = old('end_time', $plWednesday->end_time ? \Carbon\Carbon::parse($plWednesday->end_time)->format('H:i') : '17:00');
