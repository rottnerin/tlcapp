...
@section('title', 'PL Days Management - AES Professional Learning Days')
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center text-gray-500">
                            ...
                            <a href="{{ route('admin.pddays.create') }}" class="mt-4 inline-flex items-center px-4 py-2 bg-gray-900 border border-transparent rounded-md font-semibold text-white hover:bg-gray-800">
