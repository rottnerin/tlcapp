    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <!-- Links -->
                @if($schedule->hasLinks())
                    <div class="bg-white rounded-lg shadow-card border p-6">
                        <h2 class="text-xl font-semibold text-gray-900 mb-4">🔗 Additional Links</h2>
                        <div class="space-y-4">
                                    ...
                                    <div class="flex items-start justify-between">
                                        <div class="flex-1">
                                            ...
                                            <a href="{{ $link->formatted_url }}" 
                                               ...
                                               class="inline-flex items-center text-aes-blue hover:text-blue-700 font-medium">
